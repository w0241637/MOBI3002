...
//    }
    ...
    public DBcontent.AnimalItem getAnimalItem(int id) {
        ...
        String[] COLUMNS = {_ID, _NAME_COL, _DETAILS_COL, _ACCESS_COUNT, _LAST_ACCESSED};
        Cursor cursor =
        ...
        DBcontent.AnimalItem animalItem =
                new DBcontent().new AnimalItem(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4));
