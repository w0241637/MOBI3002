...
//    private DummyContent.DummyItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            Log.v("animalDetailFragment", "onCreate mItem=" + mItem.name);
            Log.v("animalDetailFragment", "onCreate mItem=" + mItem.id); // use this?
            Log.v("animalDetailFragment", "onCreate mItem=" + mItem.access_count);
            Log.v("animalDetailFragment", "onCreate mItem=" + mItem.details);

            System.out.println("*** times fragment accessed -> " + mItem.access_count + " <- times fragment accessed ***");
