...
//    private static final String ACCESS_COUNT = "access_count";
    ...
    private static String _LAST_ACCESSED = "last_accessed";
...
//    }
        ...
        String db_com = "CREATE TABLE " + TABLE_NAME + " (" +
                ...
                _ACCESS_COUNT + TEXT_TYPE + COMMA_SEP +
                _LAST_ACCESSED + TEXT_TYPE + COMMA_SEP +
                _WEBSITE + TEXT_TYPE + " )";
        Log.v("handleDB", "onCreate DB =" + db_com);
        db.execSQL(db_com);
    }
...
//    }
    ...
    public void addAnimal(DBcontent.AnimalItem animalItem) {
        ...
        values.put(_LAST_ACCESSED, animalItem.last_accessed); // tim added times fragment viewed
        values.put(_WEBSITE, animalItem.website); // tim added website
    ...
    public DBcontent.AnimalItem getAnimalItem(int id) {
        ...
        String[] COLUMNS = {_ID, _NAME_COL, _DETAILS_COL, _ACCESS_COUNT, _LAST_ACCESSED, _WEBSITE};
        Cursor cursor =
        ...
        DBcontent.AnimalItem animalItem =
                new DBcontent().new AnimalItem(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5));
...
//        return ac;
    ...
    public void updateLastAcc(String lastAccessed, String id) {
        SQLiteDatabase db = this.getReadableDatabase();
        db.execSQL("UPDATE " + TABLE_NAME + " SET " + _LAST_ACCESSED + " = " +"\"" +lastAccessed +"\""+ " WHERE " + _ID + " = " + id);
//        return true;
    }
